  ...
  return (
    <Html center zIndexRange={[100, 0]}>
      <div 
        ...
        className={`relative w-10 h-10 rounded-full backdrop-blur-md bg-black/60 border flex items-center justify-center transition-all duration-300 ease-out cursor-pointer select-none
      ...
      >
        ...
        {hovered && (
          <div className="absolute top-full mt-3 px-3 py-1 bg-black/90 backdrop-blur-xl border border-white/20 rounded-lg whitespace-nowrap text-[10px] font-bold tracking-wider text-white shadow-xl pointer-events-none">
            {item.name}
          </div>
        )}
      </div>
...
export default function Skills() {
  return (
    <section id="skills" className="relative w-full min-h-screen py-24 flex flex-col items-center justify-center bg-space-900 overflow-hidden">
      ...
      <div className="w-full max-w-[90rem] mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-8 z-10 relative items-center">
        ...
        <div className="lg:col-span-1 order-2 lg:order-1 flex flex-col gap-6">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 hover:border-neon-cyan/30 transition-colors duration-500 shadow-2xl relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-gray-300 font-light text-sm">
              <li className="flex items-start gap-3">
                ...
                <p>Node.js & Express Architecture</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-cyan mt-1 font-bold">›</span>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 hover:border-neon-cyan/30 transition-colors duration-500 shadow-2xl relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-gray-300 font-light text-sm">
              <li className="flex items-start gap-3">
                <span className="text-neon-cyan mt-1 font-bold">›</span>
                <p>MongoDB Aggregations</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-cyan mt-1 font-bold">›</span>
                <p>Schema Design & Optimization</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-cyan mt-1 font-bold">›</span>
        ...
        <div className="lg:col-span-2 order-1 lg:order-2 h-[50vh] lg:h-[70vh] w-full cursor-crosshair">
        ...
        <div className="lg:col-span-1 order-3 flex flex-col gap-6">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 hover:border-neon-purple/30 transition-colors duration-500 shadow-2xl relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-gray-300 font-light text-sm">
              <li className="flex items-start gap-3">
                ...
                <p>React.js Advanced Patterns</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-purple mt-1 font-bold">›</span>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 hover:border-neon-purple/30 transition-colors duration-500 shadow-2xl relative overflow-hidden group">
            ...
            <ul className="space-y-4 text-gray-300 font-light text-sm">
              <li className="flex items-start gap-3">
                <span className="text-neon-purple mt-1 font-bold">›</span>
                <p>Three.js 3D Web Experiences</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-purple mt-1 font-bold">›</span>
                <p>Payment Gateways (Razorpay)</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-neon-purple mt-1 font-bold">›</span>
                <p>Responsive UX Engineering</p>
              </li>
            </ul>
          </div>
        </div>
